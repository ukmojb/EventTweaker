...
public class MixinConfig implements ILateMixinLoader {
    ...
    static {
        addModdedMixinCFG("mixins.eventtweaker.json", "botania");
    }
    ...
    public boolean shouldMixinConfigQueue(final String mixinConfig) {
        ...
        if (supplier == null) {
            EventTweaker.logger.warn("Mixin config {} is not found in config map! It will never be loaded.", mixinConfig);
            return false;
        }
